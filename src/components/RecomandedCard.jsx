  ...
  if (loading) {
    ...
    return (
        <div className="max-w-7xl mx-auto mt-20">
            ...
            <h3 className="font-inter text-xl ">Recommanded</h3>
            ...
            <div className="md:flex gap-5 hidden ">
                {
                    items?.slice(4,8).map((data, i)=>   <div key={i}  className="">
            ...
            <div className="flex gap-5 md:hidden px-2">
                {
                    items?.slice(4,7).map((data, i)=>   <div key={i}  className="">
                        <img className="w-80 h-80 rounded-3xl" src={data?.ImageUrl} alt="" />
                        <p className="ml-14 text-xl font-inter my-2">{data?.Name}</p>
                    </div>)
                }
